            ...
            <div class="card-body">
                <table class="table table-striped" id="table_products">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $product->id }}</td>
                            <td><img width="100px" src="{{asset('uploads/products/'.$product->image)}}" /></td>
                            <td>{{ $product->name }}</td>
                            ...
                            <td height="100px" class="d-flex">
                                <a style="height: fit-content;" class="btn btn-sm btn-info icon" title="Edit"
