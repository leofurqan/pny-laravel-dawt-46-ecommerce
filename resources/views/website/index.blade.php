        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                ...
                <div class="block1 wrap-pic-w">
                    <img src="{{ asset('uploads/categories/' . $category->image) }}" alt="IMG-BANNER">

                    <a href="{{route('website.shopCategory', $category->id)}}"
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="{{ asset('uploads/products/' . $product->image) }}" alt="IMG-PRODUCT">
